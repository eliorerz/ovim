...
func (in *VirtualDataCenterSpec) DeepCopyInto(out *VirtualDataCenterSpec) {
	*out = *in
	...
	if in.CustomNetworkConfig != nil {
		in, out := &in.CustomNetworkConfig, &out.CustomNetworkConfig
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
	if in.LastHubSync != nil {
		in, out := &in.LastHubSync, &out.LastHubSync
		*out = (*in).DeepCopy()
	}
}
